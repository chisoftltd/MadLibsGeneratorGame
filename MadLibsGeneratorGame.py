...
tk.Label(root, text= 'Mad Libs Generator \n Have Fun!' , font = 'arial 20 bold').pack()
tk.Label(root, text = 'Click Any One :', font = 'arial 15 bold').place(x=40, y=80)
...
def madlib1():
    ...
    tk.Label(root, text= 'Say ' + food + ', the photographer said as the camera flashed! ' + name + ' and \nI had gone to ' + place +' to get our photos taken on my birthday. \nThe first photo we really wanted was a picture of us dressed as ' + animals + ' pretending to be a ' + profession + '.\nWhen we saw the second photo, it was exactly what I wanted. We both looked like ' + things + ' wearing ' + cloth + ' and ' + verb + ' --exactly what I had in mind' , font = 'arial 20 bold').pack()
    root.mainloop()
...
# Create buttons
tk.Button(root, text= 'The Photographer', font ='arial 15', command= madlib1, bg = 'ghost white').place(x=60, y=120)
tk.Button(root, text= 'apple and apple', font ='arial 15', command = madlib3 , bg = 'ghost white').place(x=70, y=180)
tk.Button(root, text= 'The Butterfly', font ='arial 15', command = madlib2, bg = 'ghost white').place(x=80, y=240)
